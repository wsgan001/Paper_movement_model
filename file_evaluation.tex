...
\begin{figure}[!t]
\centering
\subfigure[contact time]{\includegraphics[width=0.4\textwidth]{figures_201103/Evaluation/ext_contact/contactTime.eps}}
\subfigure[inter contact time]{\includegraphics[width=0.4\textwidth]{figures_201103/Evaluation/ext_contact/intercontactTime.eps}}
\subfigure[time vs. total contact time]{\includegraphics[width=0.4\textwidth]{figures_201103/Evaluation/ext_contact/totalContactTime.eps}}
\caption{contact time, intercontact time and total contact time for 1000 nodes to compare with the reality in the morning.}\label{figure_ext_total_contact_time}
\end{figure}
