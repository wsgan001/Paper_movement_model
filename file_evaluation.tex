...
%%\begin{figure*}[!t]
%%\centering
%%\subfigure[Real Trace]{\includegraphics[width=0.24\textwidth]{figures/Evaluation/sample/real_traces.eps}}
%%\subfigure[START]{\includegraphics[width=0.24\textwidth]{figures/Evaluation/sample/start_traces.eps}}
%%\subfigure[SP]{\includegraphics[width=0.24\textwidth]{figures/Evaluation/sample/sp_traces.eps}}
%%\subfigure[RWP]{\includegraphics[width=0.24\textwidth]{figures/Evaluation/sample/rwp_traces.eps}}
%%\caption{Trace samples.}\label{figure_tracesample}
%%\end{figure*}
%%
%%\begin{figure*}[!t]
%%\centering
%%\subfigure[Real Trace]{\includegraphics[width=0.24\textwidth]{figures/Evaluation/trace_nodedis.eps}}
%%\subfigure[START]{\includegraphics[width=0.24\textwidth]{figures/Evaluation/start_nodedis.eps}}
%%\subfigure[SP]{\includegraphics[width=0.24\textwidth]{figures/Evaluation/sp_nodedis.eps}}
%%\subfigure[RWP]{\includegraphics[width=0.24\textwidth]{figures/Evaluation/rwp_nodedis.eps}}
...
\begin{tabular}
[c]{ccc}
\epsfysize=1.2in\epsfbox{figures/Evaluation/indegree/trace_6_1000.eps} &
\epsfysize=1.2in\epsfbox{figures/Evaluation/indegree/start_6_1000.eps} &
\epsfysize=1.2in\epsfbox{figures/Evaluation/indegree/sp_16_1000.eps}\\ 
(a) Real traces of 1000 nodes, 6:00-8:00  & (b) START:1000 nodes, 6:00-8:00 & (c) SP:1000 nodes ,[0,16.67]$m/s$ \\ 
\epsfysize=1.2in\epsfbox{figures/Evaluation/indegree/trace_11_3000.eps} & 
\epsfysize=1.2in\epsfbox{figures/Evaluation/indegree/start_11_3000.eps} &
\epsfysize=1.2in\epsfbox{figures/Evaluation/indegree/sp_16_3000.eps} \\
(d) Real traces of 3000 nodes,11:00-13:00   &(e) START:3000 nodes,11:00-13:00   &(f) SP:3000 nodes ,[0,16.67]$m/s$ \\ 

\epsfysize=1.2in\epsfbox{figures/Evaluation/indegree/trace_17_3000.eps} & 
\epsfysize=1.2in\epsfbox{figures/Evaluation/indegree/start_22_3000.eps} &
\epsfysize=1.2in\epsfbox{figures/Evaluation/indegree/sp_16_3000.eps} \\
(g) Real traces of 3000 nodes, 17:00-19:00   &(h) START: 3000 nodes, 17:00-19:00 &(i) SP:3000 nodes ,[0,16.67]$m/s$ \\ 

\epsfysize=1.2in\epsfbox{figures/Evaluation/indegree/trace_22_3000.eps} & 
\epsfysize=1.2in\epsfbox{figures/Evaluation/indegree/start_22_3000.eps} &
\epsfysize=1.2in\epsfbox{figures/Evaluation/indegree/sp_16_3000.eps} \\
...
\begin{tabular}
[c]{cc}
\epsfysize=1.5in\epsfbox{figures/Evaluation/indegree/relative_err_6.eps} &
\epsfysize=1.5in\epsfbox{figures/Evaluation/indegree/relative_err_6.eps}\\ 
...
\begin{figure*}[!t]
\centering
\subfigure[1000 nodes from 6:00 to 8:00]{\includegraphics[width=0.24\textwidth]{figures/Evaluation/contact/ct1000_6.eps}}
\subfigure[3000 nodes from 11:00 to 13:00]{\includegraphics[width=0.24\textwidth]{figures/Evaluation/contact/ct3000_11.eps}}
\subfigure[3000 nodes from 17:00 to 19:00]{\includegraphics[width=0.24\textwidth]{figures/Evaluation/contact/ct3000_17.eps}}
\subfigure[3000 nodes from 22:00 to 24:00]{\includegraphics[width=0.24\textwidth]{figures/Evaluation/contact/ct3000_22.eps}}
\caption{Contact times distribution}\label{figure_contact_ct}
\end{figure*}

\begin{figure*}[!t]
\centering
\subfigure[1000 nodes from 6:00 to 8:00]{\includegraphics[width=0.24\textwidth]{figures/Evaluation/contact/ict1000_6.eps}}
\subfigure[3000 nodes from 11:00 to 13:00]{\includegraphics[width=0.24\textwidth]{figures/Evaluation/contact/ict3000_11.eps}}
\subfigure[3000 nodes from 17:00 to 19:00]{\includegraphics[width=0.24\textwidth]{figures/Evaluation/contact/ict3000_17.eps}}
\subfigure[3000 nodes from 22:00 to 24:00]{\includegraphics[width=0.24\textwidth]{figures/Evaluation/contact/ict3000_22.eps}}
\caption{Inter-contact times distribution }\label{figure_contact_ict}
\end{figure*}

\begin{figure*}[!t]
\centering
\subfigure[1000 nodes from 6:00 to 8:00]{\includegraphics[width=0.24\textwidth]{figures/Evaluation/contact/tc1000_6.eps}}
\subfigure[3000 nodes from 11:00 to 13:00]{\includegraphics[width=0.24\textwidth]{figures/Evaluation/contact/tc3000_11.eps}}
\subfigure[3000 nodes from 17:00 to 19:00]{\includegraphics[width=0.24\textwidth]{figures/Evaluation/contact/tc3000_17.eps}}
\subfigure[3000 nodes from 22:00 to 24:00]{\includegraphics[width=0.24\textwidth]{figures/Evaluation/contact/tc3000_22.eps}}
...
\begin{figure*}[!t]
\centering
\subfigure[1000 nodes from 6:00 to 8:00]{\includegraphics[width=0.24\textwidth]{figures/Evaluation/contact/6ct.eps}}
\subfigure[3000 nodes from 11:00 to 13:00]{\includegraphics[width=0.24\textwidth]{figures/Evaluation/contact/11ct.eps}}
\subfigure[3000 nodes from 17:00 to 19:00]{\includegraphics[width=0.24\textwidth]{figures/Evaluation/contact/17ct.eps}}
\subfigure[3000 nodes from 22:00 to 24:00]{\includegraphics[width=0.24\textwidth]{figures/Evaluation/contact/22ct.eps}}
\caption{Contact times distribution}\label{figure_contact_ct}
\end{figure*}

\begin{figure*}[!t]
\centering
\subfigure[1000 nodes from 6:00 to 8:00]{\includegraphics[width=0.24\textwidth]{figures/Evaluation/contact/6ict.eps}}
\subfigure[3000 nodes from 11:00 to 13:00]{\includegraphics[width=0.24\textwidth]{figures/Evaluation/contact/11ict.eps}}
\subfigure[3000 nodes from 17:00 to 19:00]{\includegraphics[width=0.24\textwidth]{figures/Evaluation/contact/17ict.eps}}
\subfigure[3000 nodes from 22:00 to 24:00]{\includegraphics[width=0.24\textwidth]{figures/Evaluation/contact/22ict.eps}}
