...
\begin{figure*}[!t]
\centering
\subfigure[average]{\includegraphics[width=0.28\textwidth]{figures/evalue/indegree/avg.eps}}
\subfigure[variance of in-degree]{\includegraphics[width=0.28\textwidth]{figures/evalue/indegree/var_in.eps}}
\subfigure[variance of out-degree]{\includegraphics[width=0.28\textwidth]{figures/evalue/indegree/var_out.eps}}
...
\begin{figure}[!h]
\centering
\epsfysize=1.5in\epsfbox{figures/evalue/indegree/17indegree_rwp.eps} 
...
\begin{figure*}[!t]
\centering
\subfigure[relative error of in-degree]{\includegraphics[width=0.32\textwidth]{figures/evalue/indegree/err_in.eps}}
\subfigure[relative error of out-degree]{\includegraphics[width=0.32\textwidth]{figures/evalue/indegree/err_out.eps}}
\caption{average and variance of in/out-degree.}\label{figure_avg}
\end{figure*}
