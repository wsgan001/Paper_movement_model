...
$\bigcup AREA_{load}=\bigcup AREA_{drop}=AREA$
%%
$p_{i\rightarrow j}^{0\rightarrow 1}$
$p_{i\rightarrow j}^{1\rightarrow 0}$
\begin{figure*}[htbp]
\centering
\subfigure[drop-passenger event regions]{\includegraphics[width=0.3\textwidth]{figures_201103/region/Areas-2011_event0.eps}}
\subfigure[load-passenger event regions]{\includegraphics[width=0.3\textwidth]{figures_201103/region/Areas-2011_event1.eps}}
