...
\begin{figure}[!t]
\centering
\subfigure[drop event regions]{\includegraphics[width=0.23\textwidth]{figures/region/Areas-2011_event0.eps}}
\subfigure[load event regions]{\includegraphics[width=0.23\textwidth]{figures/region/Areas-2011_event1.eps}}
\centering
